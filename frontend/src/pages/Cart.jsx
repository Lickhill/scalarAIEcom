		...
		<div className="border-t pt-14">
					...
					return (
						...
						>
							...
							<input
								...
								className={`border max-w-20 sm:px-2 py-1 ${
									productData.stock === 0
			...
			<div className="flex justify-end my-20">
				<div className="w-full sm:w-[450px]">
					<CartTotal />
					{hasOutOfStockItems && (
						<p className="text-red-600 font-semibold text-sm my-4 text-center">
							⚠️ Please remove out-of-stock items before checkout
						</p>
					)}
